...
import { Package, LayoutTemplate, Users, Image } from 'lucide-react';

export default function AdminPage() {
  const [stats, setStats] = useState({ products: 0, templates: 0, users: 0, generations: 0 });
  ...
  const cards = [
    ...
    { label: 'Templates', value: stats.templates, icon: LayoutTemplate, color: 'text-violet-400 bg-violet-500/10' },
